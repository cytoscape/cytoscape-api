...
public interface CyJobMonitor {
	 ...
	 */
	default public void jobStatusChanged(CyJob job, CyJobStatus status) { };
	 ...
	 * thread spawned from {@link #jobStatusChanged(CyJob, CyJobStatus) jobStatusChanged}, then when the user indicates
