...
public final class ColorButton extends JButton {
	...
	/**
	 * The basic constructor for a color button without palettes. The <b>color</b>
	 * argument is the initial color.
	 *
	 * @param color
	 */
	public ColorButton(Color color) {
		...
		addActionListener(evt -> {
			// Open color chooser
			var c = CyColorChooser.showDialog(ColorButton.this, "Colors", this.color);
			ColorButton.this.setColor(c);
		});
	}

	/**
	 * The basic constructor for a color button with palettes. The <b>color</b>
	 * argument is the initial color, and the <b>palette</b> argument is the initial
	 * palette. Because palettes are dynamic, the caller must provide the
	 * CyServiceRegistrar service and pass that to this constructor.
	 *
	 ...
	 */
	public ColorButton(CyServiceRegistrar serviceRegistrar, Palette palette, PaletteType type, Color color,
			boolean paletteOnly) {
		super(" ");
		init(color);
		setPalette(palette);
		...
		addActionListener(evt -> {
			...
			var chooser = chooserFactory.getColorPaletteChooser(type, paletteOnly);
			var title = "Colors";
