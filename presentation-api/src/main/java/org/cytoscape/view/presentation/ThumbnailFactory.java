...
public interface ThumbnailFactory {
	...
	/**
	 * <p>
	 * If true the network will be automatically centered inside the image bounds.
	 * </p><p>
	 * If false then the network Visual Properties NETWORK_SCALE_FACTOR, 
	 * NETWORK_CENTER_X_LOCATION, NETWORK_CENTER_Y_LOCATION will be used to position and scale
	 * the image. The origin for the image coordinates is at the center of the image.
	 * </p>
	 * Default: true.
	 */
	...
	Image getThumbnail(CyNetworkView networkView, Map<String,Object> properties);
