...
/**
 * Listener for {@linkplain ColumnVisualStyleAboutToBeRemovedEvent}.
 * @CyAPI.Spi.Interface
 * @CyAPI.InModule vizmap-api
 */
public interface ColumnVisualStyleAboutToBeRemovedListener extends CyListener {
	 ...
	 */
	void handleEvent(ColumnVisualStyleAboutToBeRemovedEvent e);
}
