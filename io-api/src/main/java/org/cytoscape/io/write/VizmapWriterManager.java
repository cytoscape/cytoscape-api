...
public interface VizmapWriterManager extends CyWriterManager<VizmapWriterFactory> {
	 ...
	 * @throws Exception 
	 */
	CyWriter getWriter(Set<VisualStyle> networkStyles, Set<VisualStyle> tableStyles, Set<StyleAssociation> columnStyleAssociations, CyFileFilter filter, File file) throws Exception;
	 ...
	 * @throws Exception 
	 */
	CyWriter getWriter(Set<VisualStyle> networkStyles, Set<VisualStyle> tableStyles, Set<StyleAssociation> columnStyleAssociations, CyFileFilter filter, OutputStream os) throws Exception;
}
